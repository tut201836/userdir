                ...
                "elements": [
                    {
                        "type": "Transform",
                        "rotation": [-1, 0, 0, 90],
                        "translation": [0.1 + (-i * 0.51), 0, (j * (joint_width + 0.01)) - (0.5 * joint_width * z_joint_count)],
                        "elements": [
                            {
                                "type": "Transform",
...
if __name__ == "__main__":
    generate_choreonoid_body_and_spring_settings(x_joint_count=15, z_joint_count=4, joint_width=0.3)
